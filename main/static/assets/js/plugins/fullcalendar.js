...
var FullCalendar = function(e) {
    ...
    function Dn(e, t, n, r, o, i, a) {
        ...
        var f = p.range.start
          ...
          , m = we(f).valueOf() === we(v).valueOf()
          , y = we(ye(h, -1)).valueOf() === we(ye(g, -1)).valueOf();
    ...
    function Mo(e, t, n, o) {
        ...
        case "FETCH_EVENT_SOURCES":
            return Po(e, t.sourceIds ? Le(t.sourceIds) : Ho(e, o), s, t.isRefetch || !1, o);
        case "RECEIVE_EVENTS":
    ...
    var na = function(e) {
        ...
        t.prototype.render = function() {
            var e = this.props
              ...
              , a = this.renderMicroColGroup(i, t.shrinkWidth)
              , s = Ji(e.liquid, n);
            e.collapsibleWidth && s.push("fc-scrollgrid-collapsible");
            for (var l, u = r.length, c = 0, d = [], p = [], f = []; c < u && "header" === (l = r[c]).type; )
                d.push(this.renderSection(l, a)),
                c += 1;
            for (; c < u && "body" === (l = r[c]).type; )
                p.push(this.renderSection(l, a)),
                c += 1;
            for (; c < u && "footer" === (l = r[c]).type; )
                f.push(this.renderSection(l, a)),
                c += 1;
            var h = !pr();
            return Ar("table", {
                className: s.join(" "),
